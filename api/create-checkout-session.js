...
module.exports = async (req, res) => {
  ...
  try {
    // Vercel zwykle parsuje JSON, ale zabezpieczmy oba przypadki
    ...
    // Walidacja i mapowanie pozycji koszyka
    ...
    // Skąd przyszła strona (frontend) – ważne dla success/cancel URL
